...
One marker for rows that can't carry one verdict: `mixed` — the row is a container (e.g. "fields") and the real verdicts live in that construct's own table below.
