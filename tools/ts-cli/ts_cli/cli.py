...
from ts_cli.commands import audit, auth, connections, databricks, dependency, dependency_apply, load, metadata, orgs, profiles, snowflake, spotql, tables, tableau, tml, users, variables  # noqa: F401 — dependency_apply registers `apply-change` on dependency.app at import
