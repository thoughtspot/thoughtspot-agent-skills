...
# If not present in smoke-config.local.json, these are skipped with a warning.
REQUIRED_EXTRA_ARGS: dict[str, list[str]] = {
    "ts-dependency-manager":        ["--model-name"],
    "ts-object-model-coach":        ["--model-name", "--column-name"],
