...
|---|---|---|---|:-:|:-:|:-:|
| [`ts-convert-to-snowflake-sv`](agents/cli/ts-convert-to-snowflake-sv/SKILL.md) | Convert a ThoughtSpot model to a Snowflake Semantic View (single, split by domain, or update existing) | Snowflake | — | [✓](agents/cli/ts-convert-to-snowflake-sv/SKILL.md) | [✓](agents/coco-snowsight/ts-convert-to-snowflake-sv/SKILL.md) | — |
...
| [`ts-convert-to-databricks-mv`](agents/cli/ts-convert-to-databricks-mv/SKILL.md) | Convert a ThoughtSpot model to a Databricks Metric View (v0.1 single-source or v1.1 multi-source) | Databricks | — | [✓](agents/cli/ts-convert-to-databricks-mv/SKILL.md) | — | [✓](agents/databricks/skills/ts-convert-to-databricks-mv/SKILL.md) |
