...
| `ts-convert-from-snowflake-sv` | `/ts-convert-from-snowflake-sv` | Convert a Snowflake Semantic View into a ThoughtSpot Model; supports merging multiple Semantic Views into one model |
