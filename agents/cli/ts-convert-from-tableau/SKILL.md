...
|---|---|---|
| 1.20.1 | 2026-07-03 | Doc refresh: output schema + flag fixes, mapping-file greatest/least + pipeline-table alignment, matrix/open-items verification pass (4 stale items closed), gap documentation (hierarchies, aliases, actions, fiscal year, inverse trig) |
