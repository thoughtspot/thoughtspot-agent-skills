...
snow stage copy agents/coco-snowsight/ts-setup-snowflake-udfs-business-days/SKILL.md @SKILLS.PUBLIC.SHARED/skills/.snowflake/cortex/skills/ts-setup-snowflake-udfs-business-days/ --overwrite
