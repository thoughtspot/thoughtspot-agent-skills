...
| agents/cursor/rules/ts-convert-from-snowflake-sv.mdc | v1.3.1 | v1.7.1 | SV v1.4–v1.7 (N1, I7, pre-import gate, PT1, name-normalisation) | sync scheduled — BL-017 |
...
| agents/cursor/rules/ts-convert-to-snowflake-sv.mdc | v1.2.0 | v1.2.2 | SV-to v1.2.1–v1.2.2 (error-010256, checklist additions) | sync scheduled — BL-017 |
