...
> you are in a Snowsight Workspace, inform the user they must run `/ts-profile-thoughtspot`
...
(see [~/.claude/skills/ts-profile-thoughtspot/SKILL.md](~/.claude/skills/ts-profile-thoughtspot/SKILL.md) — Pattern A):
...
- **Temp file (preferred for multi-call scripts):** Authenticate using Pattern A in
  [~/.claude/skills/ts-profile-thoughtspot/SKILL.md](~/.claude/skills/ts-profile-thoughtspot/SKILL.md) — writes the token
