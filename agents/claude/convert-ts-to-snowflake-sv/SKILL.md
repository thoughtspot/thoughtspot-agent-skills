...
| [~/.claude/skills/setup-snowflake-profile/SKILL.md](~/.claude/skills/setup-snowflake-profile/SKILL.md) | Snowflake connection code, SQL execution patterns, SHOW commands for case-sensitivity |
...
Can you log into ThoughtSpot in a browser (even via SSO)?
  ...
  NO  → password_env or secret_key_env — see setup-ts-profile.md
```
...
See [~/.claude/skills/setup-snowflake-profile/SKILL.md](~/.claude/skills/setup-snowflake-profile/SKILL.md) for the
...
[~/.claude/skills/setup-snowflake-profile/SKILL.md](~/.claude/skills/setup-snowflake-profile/SKILL.md) — including the
